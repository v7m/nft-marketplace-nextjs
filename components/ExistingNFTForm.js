...
export default function ExistingNFTForm({
    ...
    const showExistingNftProgress = (nftProcessing.matches('form') && !newNftState.matches('idle'));

    const minPriceValue = ethers.utils.formatUnits(svgNftMintFee, "ether");
    ...
    return (
        <div>
            ...
            <form onSubmit={ handleFormSubmit }>
                <div className="mb-6">
                    <label htmlFor="nft-address-input" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">NFT address</label>
                    <select id="nft-address-input" name="nft-address" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        <option value={ basicIpfsNftAddress }>Basic IPFS NFT ({ basicIpfsNftAddress })</option>
                        <option value={ dynamicSvgNftAddress }>Dynamic SVG NFT ({ dynamicSvgNftAddress })</option>
                    </select>
                </div>
                <div className="mb-6">
                    <label htmlFor="token-id-input" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Token ID</label>
                ...
                <div className="mb-6">
                    <label htmlFor="price-input" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Price (ETH)</label>
